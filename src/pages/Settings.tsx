...
const INDUSTRIES = [
  ...
  'Construction', 'Consulting', 'Education', 'Energy', 'Events & Hospitality',
  'Fashion & Apparel', 'Finance & Accounting', 'Food & Beverage', 'Healthcare',
  ...
  'Social Services', 'Technology', 'Telecommunications', 'Tourism & Travel',
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div><Label>Industry</Label>
              <Select value={form.industry} onValueChange={v => setForm(p => ({ ...p, industry: v }))}>
                <SelectTrigger className="rounded-[5px]"><SelectValue placeholder="Select industry..." /></SelectTrigger>
                <SelectContent>
